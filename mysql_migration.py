...
"""
        ...
        tables_to_drop = [
            'user_sessions', 'password_reset_tokens', 'barcode_labels', 'bin_scanning_logs',
            'inventory_count_items', 'inventory_counts', 'pick_list_items', 'pick_lists',
            'inventory_transfer_items', 'inventory_transfers', 'grn_items', 'grn_documents',
            'document_number_series', 'branches', 'users'
        ]
        ...
        for series_name, prefix, current_number, year_suffix in document_series:
            cursor.execute("""
                INSERT INTO document_number_series (series_name, prefix, current_number, year_suffix)
                VALUES (%s, %s, %s, %s)
            """, (series_name, prefix, current_number, year_suffix))
        print("✅ Created document number series")
